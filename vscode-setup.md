...
I show how to set up VS Code with a personal themes, extensions and settings to optimise the coding experience.

### Theme

I use the `One Monokai` theme. This is a free theme, similar to Monokai Pro. [Link &rarr;](https://marketplace.visualstudio.com/items?itemName=azemoh.one-monokai)
