    ...
    <section className="bg-white dark:bg-gray-900">
      ...
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light  sm:text-lg ">
          <h3 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">
            Connou
          </h3>
      ...
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light  sm:text-lg ">
          ...
          <p className="my-4">
            Developed a multi-page website for a law firm using React and
            Bootstrap, ensuring responsiveness and aesthetic appeal.
          </p>
          <div className="flex gap-4">
            <a
        ...
        <div className="grid ">
          ...
          >
            <img
              className="mt-4 w-full lg:mt-10 rounded-lg"
              src="./images/portfolio/portfolio-solicitors.png"
              alt="Recipe Platform"
            />
          </a>
        </div>
